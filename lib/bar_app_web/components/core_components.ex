defmodule BarAppWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: BarAppWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BarAppWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BarAppWeb.Gettext, "errors", msg, opts)
    end
  end
